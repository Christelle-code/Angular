// To parse this data:
//
//   import { Convert, GIFInterface } from "./file";
//
//   const gIFInterface = Convert.toGIFInterface(json);
//
...
export class Convert {
    public static toGIFInterface(json: string): GIFInterface {
        return cast(JSON.parse(json), r("GIFInterface"));
    }

    public static gIFInterfaceToJson(value: GIFInterface): string {
        return JSON.stringify(uncast(value, r("GIFInterface")), null, 2);
    }
}
